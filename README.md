...
Education: BE in Computer Engineering, St. Francis Institue of Technology
Focus:     Data Science | Machine Learning | Analytics | Graphics
```

- 🌱 Began the journey with Python and SQL, now diving deep into **Data Analytics & Visualization**
- 📊 I work on dashboards and reports with **Excel, Power BI, and Tableau**
- 🎓 Currently pursuing a degree in **Computer Engineering with Honours in Data Science**
- 💬 Ask me about Python, SQL, Power BI, Tableau, and Data Analysis
- ⚡ Interested in Machine Learning, Automation, and turning raw data into decisions
- 🎯 I only like clean dashboards and clean code
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,mysql,html,css,js,git,vscode,figma,notion" />
</p>
